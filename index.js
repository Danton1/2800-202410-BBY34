...
async function connectToDatabase() {
    const uri = `mongodb+srv://${mongodb_user}:${mongodb_password}@${mongodb_host}/${mongodb_database}?retryWrites=true&w=majority`; // Updated URI
...
(async () => {
    ...
    const tokenCollection = database.collection('forgotToken');
